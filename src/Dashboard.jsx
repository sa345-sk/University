                   ...
                   {crimes && crimes.map((crime, index) => (
                     <div key={crime.id} id='data'>
                        ...
                        <p className='cell' style={{paddingLeft: '40px'}}>{crime.date}</p>
                         ...
                         <Link  className='cell'to={`/${crime.id}`}><button style={{ border: '0', background: '#d7006f', width: '80px', height: '26px', borderRadius: '10px 10px 10px 10px', cursor: 'pointer', marginLeft: '60px', marginBottom: '2px', marginTop: '2px'}}>View Details</button></Link>
                     </div>
                   ))}
